    ...
    return (
        <div className="reset-password-container">
            <div className="reset-password-card">
                ...
                {errorMessage && <Alert message={errorMessage} type="error" showIcon className="reset-alert" />}
                {successMessage && <Alert message={successMessage} type="success" showIcon className="reset-alert" />}
                ...
                <Form layout="vertical" onFinish={handleSubmit}>
                    ...
                    <Form.Item className="reset-submit-button">
