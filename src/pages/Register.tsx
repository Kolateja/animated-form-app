...
const Register: React.FC<RegisterProps> = ({ onToggleForm }) => {
  const onFinish = async (values: any) => {
    try {
      ...
      const message =
        error?.response?.data?.error?.errors?.[0]?.message || "Error creating user";
      alert(message);
    }
  };
            ...
            <Form layout="vertical" onFinish={onFinish}>
              <Row gutter={16}>
                <Col xs={24} sm={24} md={12}>
                  ...
                  >
                    <Input placeholder="Enter your username" className="register-input" />
                  </Form.Item>
                </Col>
                <Col xs={24} sm={24} md={12}>
                  <Form.Item
                  ...
                  >
                    <Input placeholder="Enter your phone number" className="register-input" />
                  </Form.Item>
                </Col>
              </Row>
              ...
              <Row gutter={16}>
                ...
                <Col xs={24} sm={24} md={12}>
                  ...
                  >
                    <Input.Password placeholder="Create a password" className="register-input" />
                  </Form.Item>
                </Col>
              </Row>

              <Form.Item>
                <Button type="primary" htmlType="submit" block size="large" className="register-button">
                  Register
                </Button>
              </Form.Item>
            </Form>
