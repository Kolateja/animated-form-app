...
const AssessmentHelpPage = () => {
    return (
        <div style={{ fontFamily: 'Arial, sans-serif', padding: '20px' }}>
            ...
            <div style={{ marginBottom: '40px' }}>
                <h2>Types of Help with Assessment Tasks We Offer</h2>
                <ul>
                    <li>Research Paper Writing Service</li>
                    <li>Assignment Editing Service</li>
                    <li>Essay Editing Service</li>
                    <li>Dissertation Editing Service</li>
                    <li>Paper Editing Service</li>
                    <li>Term Paper Writing Service</li>
                </ul>
            </div>
        </div>
    );
