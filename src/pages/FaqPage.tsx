...
import { Tabs, Typography, Row, Col, Collapse } from 'antd';
import { useState } from 'react';
import { MessageOutlined } from '@ant-design/icons';
import './FaqPage.css';
...
const faqs = {
    ...
    // Payment & Portal omitted for brevity (you can keep them as-is)
            ...
            {faqList.map((faq, index) => (
                <Panel header={<b>{faq.question}</b>} key={index}>
                    <div className="faq-answer">
                        <MessageOutlined className="faq-icon" />
                        <Paragraph className="faq-paragraph">{faq.answer}</Paragraph>
                    </div>
                </Panel>
            ))}
        </Collapse>
...
const FaqPage = () => {
    ...
    return (
        <div className="faq-page">
            <Row justify="center" className="faq-header">
                <Col>
            ...
            >
                ...
                <TabPane tab="Payment Related" key="payment">
                    {renderFaqs(faqs.payment)}
                </TabPane>
                <TabPane tab="Student Portal" key="portal">
                    {renderFaqs(faqs.portal)}
                </TabPane>
            </Tabs>
        </div>
