...
const policyItems = [
    {
        ...
        items: [
            {
                title: 'In case of unavailability of the Writer or Busy with the scheduled writing',
                description:
    ...
    },
    {
        ...
        items: [
            {
                title: 'In case of Dissatisfactory Results Compensation (factual proof)',
                description:
            ...
            },
            {
                ...
                description:
                    'No refund once a writer has started the assignment.'
            },
            {
