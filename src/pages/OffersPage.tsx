...
const dissertationOffers = [
    {
        ...
        point: 'We offer a 5% discount on any order of a dissertation or an essay of 250 to 5,000 words. Place your order now!'
    },
    {
        title: '10% Discount',
        bg: 'linear-gradient(to right, #00ced1, #20b270)',
        point: 'We offer a 10% discount on any order of a dissertation or an essay of 5250 to 10,000 words. Place your order now!'
    },
    {
        title: '15% Discount',
        bg: 'linear-gradient(to right, #fbfbf9, #c8c0b2)',
        point: 'On all orders of 10,000 words and above, you will receive an automatic 15% discount! Place your order now!'
    }
];
