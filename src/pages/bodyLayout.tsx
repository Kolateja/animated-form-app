  ...
  return (
    ...
    <div className="layout-content">
      <Routes>
        ...
        />
        <Route
          path="/powerpoint-presentation-service"
        ...
        <Route
          path="/editing-and-proofreading-service"
          element={<EditingWriting />}
        />
        ...
        <Route
          ...
          element={<AuthPage handleLoginFlag={handleLoginFlag} />}
        />
        ...
        <Route
          path="/academicView/:userId"
          element={<AcademicDetailsComponent />}
        />
        ...
        <Route
          path="/add-writer-feedback/:userId"
          element={<WriterFeedbackForm />}
        />
        <Route
          path="/edit-writer-details/:userId"
          element={<EditWriterDetails />}
        />
        <Route
          path="/edit-writer-feedback/:userId"
          element={<EditWriterFeedback />}
        />
        <Route
          path="/userDetails/:id/:userId"
          element={<CombinedUserDetailsComponent />}
        />

        <Route
          path="/writerDetails/:id/:userId"
          element={<WriterDetailsPage />}
        />
        <Route
          path="/writerEditDetails/:id/:userId"
          element={<WriterEditDetailsPage />}
        />
        <Route
          path="/orderDetails/:userId/:orderId"
          element={<CombinedOrderDetailsComponent />}
        />
      </Routes>
    </div>
    // </div>
