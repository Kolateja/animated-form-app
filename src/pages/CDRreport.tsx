...
const cdrSubjects = [
    ...
    "Stage 1 & 2 Competency Claims",
    "Plagiarism Removal for CDR",
    "CDR Review & Editing",
    "RPL for ACS",
    "KAO & KSA Writing",
    "Engineering Disciplines Specific CDRs",
    "Professional CV Writing",
];

const reviews: Review[] = [
    { name: 'Meera', orderId: 'CDR - 1001', text: 'They wrote my Career Episodes and Summary Statement perfectly. Got my EA approval on the first attempt!', rating: 5 },
    { name: 'Rohan', orderId: 'CDR - 1002', text: 'Extremely professional and plagiarism-free CDR writing. Highly recommended.', rating: 5 },
    { name: 'Simran', orderId: 'CDR - 1003', text: 'Thanks to their help, my ACS RPL application was approved smoothly.', rating: 5 },
    { name: 'Amit', orderId: 'CDR - 1004', text: 'Accurate formatting and solid engineering project writing. Great experience.', rating: 5 },
];
...
const cdrWriters: Feedback[] = [
    {
        name: 'Dr. Ananya',
        education: 'PhD in Civil Engineering',
        completedOrders: 180,
        message: 'Helping engineers secure EA approvals with strong CDR documentation.',
        rating: 5,
    },
    {
        name: 'Ritika',
        ...
        completedOrders: 150,
        message: 'I structure Career Episodes with accurate project reflections.',
        rating: 5,
    },
    {
        name: 'Vikram',
        ...
        completedOrders: 200,
        message: 'Ensuring compliance with MSA Booklet standards.',
        rating: 5,
    },
    {
        name: 'Sneha',
        ...
        completedOrders: 170,
        message: 'Providing plagiarism-free and well-articulated CDR documents.',
        rating: 5,
    },
];
