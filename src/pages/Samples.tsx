    ...
    <>
      ...
      >
        <div className="container">
          ...
          >
            Browse through our selection of samples and take the first step
            towards enhancing your learning experience today.
          </Paragraph>
        </div>
              ...
              <Col xs={24} sm={12} md={8} key={sample.id}>
                ...
                >
                  ...
                  <Button
                    ...
                    onClick={() =>
                      sample.pdfUrl && window.open(sample.pdfUrl, "_blank")
                    }
                  >
